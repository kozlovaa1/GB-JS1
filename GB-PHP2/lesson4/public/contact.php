<? include "../templates/header.php"; ?>
    ...
    <p>Мы один из самых крупных складов комплектующих для ноутбуков в Москве. Центральный офис нашей компании расположен
        в Москве, а филиалы находятся в нескольких крупных городах России и ближнего зарубежья: Санкт-Петербург,
        Саратов, Нижний Новгород, Волгоград, Омск, Минск. Отлаженная логистика позволяет максимально уменьшить сроки
        доставки по Москве и в регионы.</p>
    <div class="map">
    ...
    <form action="#" class="form-item" method="post">
        <p>
            ...
            <input type="text" id="display-name" name="display-name" size="30" maxlength="20" placeholder="Введите Имя"
                   required>
        </p>
        <p>
